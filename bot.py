...
gif = [
    'https://te.legra.ph/file/619350e1a41449d48b111.jpg'
]
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="https://telegram.me/Auto_Approve_Tamilan_Bot?startgroup")
                    ]
                ]
            )
            add_user(m.from_user.id)
            await m.reply_photo("https://te.legra.ph/file/8f35df866ada8c7baff7c.jpg", caption="**{}\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your Channel Or Group and promote me Admin with add members permission.\n\n__By : @SK_MoviesOffl__**".format(m.from_user.mention, "https://telegram.dog/SK_MoviesOffl"), reply_markup=keyboard)
